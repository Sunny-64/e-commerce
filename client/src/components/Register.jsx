        ...
        <div className="w-full max-w-xs mt-14 mx-auto">
            <form className="form shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div className="mb-4">
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name='name' id="username" type="text" placeholder="Username" />
                </div>
                <div className="mb-4">
